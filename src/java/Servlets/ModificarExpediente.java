...
public class ModificarExpediente extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String domicilioUsuario = request.getParameter("Domicilio");
            ...
            boolean validado = cons.modificarExpediente(idUsuario, nombreUsuario, domicilioUsuario,  telefonoUsuario,  padecimientoUsuario);
            ...
            if (validado) {
                ...
                out.println("<html>");
                out.println("<head>");
                out.println("<title>Modificar expediente</title>");
                ...
                out.println("<br><a href='Expedientes.jsp'><button class='btn btn-secondary'>Volver</button></a>");
                out.println("</div>");
