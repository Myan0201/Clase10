...
public class ModificarUsuarios extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String contraUsuarios = request.getParameter("contra");
            String nombreUsuario = request.getParameter("nombre");
            String tipoUsuario = request.getParameter("tipo");

            Consultas cons = new Consultas("clinica", "root", "");

            boolean validado = cons.modificarUsuario(idUsuario, contraUsuarios, nombreUsuario, tipoUsuario);
            ...
            if (validado) {
                ...
                out.println("<br><h1>No se pudo modificar el usuario: " + nombreUsuario + "</h1><br>");
